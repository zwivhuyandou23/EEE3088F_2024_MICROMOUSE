...
#define THRESHOLD_LOW  431 // ADC threshold for LED off
#define THRESHOLD_HIGH 539 // ADC threshold for LED on

#define EMITTER1_PIN GPIO_PIN_1
#define EMITTER1_PORT GPIOB
#define EMITTER2_PIN GPIO_PIN_2
#define EMITTER2_PORT GPIOB
#define EMITTER3_PIN GPIO_PIN_10
#define EMITTER3_PORT GPIOB
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
		 ...
		 HAL_Delay(1000);
		  ...
		  lcd_command(LCD_CLEAR_DISPLAY);
		  HAL_Delay(100);
		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0, GPIO_PIN_RESET);//PWM Sleep moode
		  HAL_Delay(100);*/
  }
  /* USER CODE END 3 */
}
